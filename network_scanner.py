...
#
#     parser.add_argument("-i", "--ip-address", dest="ip", help="Network IP address to scan ")
#     parser.add_argument("-s","--subnet", dest="net_mask", help="Network Subnet mask ")
#
#     val = parser.parse_args()

# ****** rest is the same just uncomment the this one & comment the optparse module ******
